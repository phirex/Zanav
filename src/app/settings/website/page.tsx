  ...
  const saveWebsiteData = async (data: Partial<KennelWebsite>) => {
    try {
      ...
      if (!tenantId) {
        toast({
          title: "Error",
          description: "No tenant ID found. Please refresh the page.",
          variant: "destructive",
        });
        return;
      }
      ...
      toast({
        title: "Error",
        description: `Failed to save website settings: ${error instanceof Error ? error.message : "Unknown error"}`,
        variant: "destructive",
      });
    } finally {
      setIsSaving(false);
  ...
  const updateSubdomain = async (newSubdomain: string) => {
    try {
      ...
      if (!response.ok) {
        ...
        toast({
          title: "Error",
          description: error.error || "Failed to update subdomain",
          variant: "destructive",
        });
        // Revert the change
  ...
  const handleGalleryFileUpload = async (file: File) => {
    try {
      ...
      if (file.size > maxSize) {
        handleGalleryUploadError("File size must be less than 5MB");
        return;
      }

      const allowedTypes = ["image/jpeg", "image/png", "image/webp"];
      if (!allowedTypes.includes(file.type)) {
        handleGalleryUploadError("Only JPEG, PNG, and WebP files are allowed");
        return;
      }
      ...
      <div className="max-w-3xl mx-auto py-10 px-4">
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mb-4">
                  This will be the main image displayed at the top of your
                  website. Recommended size: 1920x1080px.
                </p>
                <ImageUpload
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Welcome to [Your Kennel Name]"
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Where your furry friends feel at home"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <p className="text-sm text-gray-500 mt-1">
          ...
          <section className="bg-white rounded-lg border p-6">
            ...
            <div className="space-y-4">
              <p className="text-sm text-gray-500">
                Add YouTube or Vimeo video links to showcase your kennel in
                action.
              </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  placeholder="Enter your kennel's full address"
                  rows={3}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="info@yourkennel.com"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
          ...
          <section className="bg-white rounded-lg border p-6">
            <h2 className="text-xl font-semibold mb-4">Special Restrictions</h2>
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                placeholder="e.g., Only small dogs under 20kg, Must be vaccinated, No aggressive breeds, etc."
                rows={6}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
          ...
          <section className="bg-white rounded-lg border p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  This color will be used for buttons, links, and accents on
                  your website.
                </p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Your Kennel Name - Professional Dog Boarding"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <p className="text-sm text-gray-500 mt-1">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Professional dog boarding services in [Your City]. Safe, comfortable, and loving care for your furry friends."
                  rows={3}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <p className="text-sm text-gray-500 mt-1">
          ...
          <section className="bg-white rounded-lg border p-6">
            <h2 className="text-xl font-semibold mb-4">Direct Booking</h2>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-500">
                When enabled, customers can book stays directly from your
                website. Payment processing and calendar integration will be
