...
import { ArrowLeft, MessageSquare, Save, Loader2 } from "lucide-react";
...
export default function NewTemplatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "שגיאה ביצירת התבנית");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">תבנית חדשה</h1>
          <p className="text-gray-500 mt-1">יצירת תבנית חדשה להודעות ווטסאפ</p>
        </div>
      </div>
